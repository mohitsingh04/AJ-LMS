...
import { Eye, EyeOff, Target, Mail, Lock, AlertCircle, User, Phone } from 'lucide-react';
            ...
            <div className="max-w-md w-full">
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Register to your account</p>
                    </div>
                    ...
                    <form className="space-y-6">
                        ...
                        <div className="flex items-center gap-2">
                            <input type="checkbox" />
                            <span className="text-sm text-gray-700">I agree and accept the terms and conditions</span>
                        </div>
